...
private:
    ...
    std::string getIntentName() const {
        switch (intent) {
            case MessageIntentUse::RequestSpeed: return "REQUEST Speed";
            case MessageIntentUse::RequestSpeedToSpeed: return "REQUEST Speed To Speed";
...
MessageIntentUse chooseIntent() {
    ...
    switch (choice) {
        case 1: return MessageIntentUse::RequestSpeed;
        case 2: return MessageIntentUse::RequestSpeedToSpeed;
